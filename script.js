...
const details = [
  ...
  {
    name: 'Multi School Stories',
    description: 'A web app book library that allows you add and and remove books',
    image: 'img/bookstore2.png',
    technologies: ['ruby', 'css', 'javascript', 'bootsrap'],
    live: 'https://brave-roentgen-5deb4e.netlify.app/',
    source: 'https://github.com/Whoistolu/bookstore',
  },
  {
    name: 'Multi School Stories',
